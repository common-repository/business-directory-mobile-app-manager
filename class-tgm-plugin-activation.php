...
add_action( 'tgmpa_register', 'wpbmam_register_required_plugins' );

function wpbmam_register_required_plugins() {

	$plugins = get_option('tsl-wpbdo-plugins');

	$config = array(
		'id'           => 'tsl-wbdmam',             // Unique ID for hashing notices for multiple instances of TGMPA.
	...
	if(is_array($plugins)) {
		if (sizeof($plugins) > 0) tsl_wpbdmam_tgmpa($plugins, $config);
	}
}
...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	 ...
	 */
	function tsl_wpbdmam_tgmpa( $plugins, $config = array() ) {
		...
		protected function get_plugin_source_type_text( $type ) {
			...
			switch ( $type ) {
				case 'repo':
					...
					break;
				case 'external':
					$string = __( 'TinyScreenLabs.com', 'tgmpa' );
					break;
				case 'bundled':
